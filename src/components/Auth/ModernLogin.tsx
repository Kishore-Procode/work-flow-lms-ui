...
const ModernLogin: React.FC<LoginProps> = ({ onLoginSuccess }) => {
  // Login state
  ...
  const demoUsers = [
    ...
    { email: 'smuthuviknesh2@gmail.com', role: 'Staff Member', password: 'admin123', userRole: 'staff' },
    ...
    <div className='items-center justify-center flex-auto flex flex-col min-h-screen'>
      <div className='flex-1 w-full items-center justify-center'>
        <div className='min-h-screen bg-white flex items-center justify-center px-4 sm:px-6 md:px-8'>
          ...
          <div className='w-full max-w-md flex flex-col justify-center items-center bg-white p-6 sm:p-8 rounded-2xl shadow-lg'>
            <div className='mx-auto w-full max-w-md'>
              {/* Mobile Header: Logo (left) + Register section (right) */}
              <div className='md:hidden mb-4 flex items-start justify-between gap-2'></div>

          
                {/* Header */}
             <div className="lms-card-header text-center">
              <div className="flex justify-center mb-4">
                <div className="w-16 h-16 bg-primary-600 rounded-2xl flex items-center justify-center shadow-sm">
            ...
            <p className="text-sm text-neutral-600">
              Sign in to your Student-ACT LMS account
            </p>
          </div>
          ...
          <button
            ...
            className={`flex items-center justify-center gap-2 px-6 py-3 border rounded-md font-medium transition-all text-sm sm:text-base w-full sm:w-1/2 ${
                        ...
                        {signupStep === 1 ? (
                          ...
                          <div className='space-y-4'>
                            ...
                            <div className='flex gap-4'>
                              ...
                              >
                                {loading ? 'Submiting Registration Request...' : 'Submit Registration Request'}
                              </button>
                            </div>
                          </div>
                        )}
